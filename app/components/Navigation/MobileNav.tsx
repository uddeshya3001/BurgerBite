...
const MobileNav = ({ showNav, closeNav }: Props) => {
    ...
    return (
        <div className={`fixed ${navStyle} right-0 transition-all duration-500 left-0 top-0 bottom-0 h-[100vh] bg-[#000000e0] z-[1002]`}>
            ...
            <ImCross onClick={closeNav} className='absolute top-[2rem] right-[2rem] w-[2rrem] h-[2rem] text-white cursor-pointer' />
            {/* Nav Div */}
            <div className={`bg-emerald-700 ${navStyle} transition-all duration-500 delay-200 flex flex-col items-center justify-center h-[100%] w-[70%]`}>
