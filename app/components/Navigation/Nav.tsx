        ...
        <div className='h-[12vh] bg-white'>
            <div className='sm:w-[90%] w-[95%] mx-auto flex h-[100%] items-center justify-between'>
                ...
                <div className='flex items-center space-x-2'>
                    <FaBurger className='w-[1.5rerm] h-[1.5rem] sm:w-[1.4rem] sm:h-[1.4rem] text-orange-500' />
                    <h1 className='text-[20px] sm:text-[30px] font-semibold'>Burger Bite</h1>
                </div>
                {/*nav links*/}
                <ul className="hidden lg:flex items-center space-x-10">
                    <li className='text-[25px] font-medium hover:text-red-600'>
                        <Link href='/'>Home</Link>
                    </li>
                    <li className='text-[25px] font-medium hover:text-red-600'>
                        <Link href='/'>Shop</Link>
                ...
                <div className="flex items-center space-x-4">
                    <button className='px-6 py-2 sm:px-8 sm:py-3 text-[14px] sm:text-[16px] bg-blue-950 transition-all duration-200 hover:bg-red-600 flex items-center space-x-2 rounded-md text-white'>
                        <span>
